...
public class CreateUser {
    @Test
    @DisplayName("Create user is successful")
    public void createUserSuccessfully() {
        JSONObject body = new JSONObject();
        body.put("Email", "adrian.parcial@gmail.com");
        body.put("FullName", "AdrianSAN");
        body.put("Password", "0311adrian");
    ...
    public void createAProjectWithToken() {
        Response tokenResponse = given()
                .auth()
                .preemptive()
                .basic("adrian.parcial@gmail.com", "0311adrian")
                .log().all()
                .when()
        ...
        bodyProject.put("Content", "Proyecto de Prueba");
        ...
        bodyToken.put("UserEmail", "adrian.parcial@gmail.com");
